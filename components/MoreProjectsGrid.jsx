...
export default function MoreProjectsGrid() {
    ...
    let projects = isExpanded ? extraProjects : extraProjects.slice(0, 3);

    if (filter !== "all") {
        const filterProject = extraProjects.filter(project => project.type === filter);
        projects = isExpanded ? filterProject : filterProject.slice(0, 3);
    }
    return (
        <>
