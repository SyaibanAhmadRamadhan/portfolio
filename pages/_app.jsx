...
const SiteHead = ({ title }) => (
  <Head>
    <title>{title}</title>
    <meta name="title" content="Syaiban Ahmad Ramadhan - Software Engineer" />
    <meta name="description" content="Syaiban Ahmad Ramadhan - Portfolio" />
    ...
    <meta
      ...
      content="Syaiban Ahmad Ramadhan's personal portfolio"
    />
...
function App({ Component, pageProps }) {
  ...
  const pathToTitle = {
    "/": "Syaiban Ahmad Ramadhan - Software Engineer",
  };
