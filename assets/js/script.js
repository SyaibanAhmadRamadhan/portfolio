...
const testimonialsItem = document.querySelectorAll('[data-portfolio-item]');
...
for (let i = 0; i < testimonialsItem.length; i++) {
  testimonialsItem[i].addEventListener('click', function () {
    ...
    modalImg.innerHTML = this.querySelector;
    modalTitle.innerHTML = this.querySelector(
      '[data-portfolio-title]'
    ).innerHTML;
    modalText.innerHTML = this.querySelector('[data-portfolio-text]').innerHTML;
    modalTech.innerHTML = this.querySelector('[data-portfolio-tech]').innerHTML;
    modalCreated.innerHTML = this.querySelector('[data-portfolio-created]').innerHTML;
    modalSource.innerHTML = this.querySelector(
